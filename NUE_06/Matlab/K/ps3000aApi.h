...
#define PS3206A_MAX_INTERLEAVE	100

#define PS3205A_MAX_ETS_CYCLES	250
#define PS3205A_MAX_INTERLEAVE	50

#define PS3204A_MAX_ETS_CYCLES	125
#define PS3204A_MAX_INTERLEAVE	25
...
PREF0 PREF1 PICO_STATUS PREF2 PREF3 (ps3000aGetTriggerChannelTimeOffset)
	(
		short									handle,
		unsigned long 			* timeUpper,
		unsigned long 			* timeLower,
...
PREF0 PREF1 PICO_STATUS PREF2 PREF3 (ps3000aGetTriggerChannelTimeOffset64)
	(
		short									handle,
		__int64							* time,
		PS3000A_TIME_UNITS	*	timeUnits,
...
PREF0 PREF1 PICO_STATUS PREF2 PREF3 (ps3000aGetValuesTriggerChannelTimeOffsetBulk)
	(
	  short									handle,
		unsigned long				*	timesUpper,
		unsigned long				* timesLower,
...
PREF0 PREF1 PICO_STATUS PREF2 PREF3 (ps3000aGetValuesTriggerChannelTimeOffsetBulk64)
	(
	  short									handle,
		__int64							*	times,
		PS3000A_TIME_UNITS	*	timeUnits,
