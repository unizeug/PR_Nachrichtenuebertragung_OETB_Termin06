...
\begin{quote}
    ...
    \begin{quote}
        ...
        Mes-sung des BER eine minimale Auflösung von $10^-4$ besitzt. Danach
        ...
        zusammengefasst. Dabei wurde für jeden Verstärkungsfaktor ein Diagramm
        mit den drei Wasserfallkurven der $\roh$ erstellt.
        
        \TODO{im Aufgabenblatt steht dass wir die Diagramme je nach roh
        erstellen sollen und die Wasserfallkurven auch während der Messung
        aufnehmen, haben wir aber nicht gemacht oder?}
